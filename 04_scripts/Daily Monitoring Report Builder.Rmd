...
```{r For_Testing, eval=FALSE, echo=FALSE}
...
data_path <- audit_zip_dir <- paste0("../02 Data Collection and Planning/Quant/4_Data_collection/", population, "/Day5/")
...
if(population == "refugee"){collapse_cols = c("collapse_living_there", "collapse_with_other_hhm", "with_other_hh", "collapse_in_open")
