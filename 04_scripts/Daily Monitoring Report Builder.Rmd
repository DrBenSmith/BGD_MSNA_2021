...
data_path <- audit_zip_dir <- paste0("../02 Data Collection and Planning/Quant/4_Data_collection/", population, "/Day6/")
...
# hh$survey_type = c("in_person", "remote") # For testing clearning
...
if(population=="host"){
  ...
  # Remote:
  survey_complete_by_reach <- progress_tracking(survey_complete_by_reach %>% filter(survey_type != "in_person"))
  survey_complete_by_reach <- survey_complete_by_reach[order(
    as.numeric(substr(x = survey_complete_by_reach$camp_name, start = 6,
                      nchar(survey_complete_by_reach$camp_name)))),]
  # In Person:
  ...
  kable_styling(kable_input = kable(x = survey_complete_by_reach, longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = "Total number of remote surveys per camp."), position = "center")
  
  kable_styling(kable_input = kable(x = survey_complete_by_reach_imp, longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = "Total number of in person surveys per camp."), position = "center")
