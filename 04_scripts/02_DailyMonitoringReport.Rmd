...
if(population == "host"){
  ...
  FCNs$Camp = gsub(pattern = "nayapara_rc", replacement = "NRC", x = FCNs$Camp)
  FCNs$Camp = gsub(pattern = "kutupalong_rc", replacement = "KRC", x = FCNs$Camp)
...
if(population=="host"){
  survey_complete_by_reach <- hh %>%  group_by(union_name) # , reported_date
} else {
...
survey_time_LT25 <- survey_time %>% filter(reported_date == day_to_run, duration_minutes <25) %>% rename("X_uuid"="uuid") # Don't think we need to filter by reported_date.
...
individuals_difficulties = left_join(x = individuals_difficulties,
                                     y = hh_consent_daily %>% select(reported_date,X_uuid,enumerator_id, enumerator_name, team, respondent_id, instance_name, hh_size)) %>% 
  mutate(
    "hh_size_fraction_raw" = hh_size/3,
    "hh_size_fraction" = round(hh_size_fraction_raw, digits=0),
    "difficulty_issue" = case_when(Indvs_with_Diffs>hh_size_fraction~ "yes", T~ NA_character_)) %>% 
...
for(i in c("roof", "window", "structure", "trap_heat", "lack_insulation")){
  ...
  print(kable_styling(
    kable(x = shelter_issues_reason_inconsistency[shelter_issues_reason_inconsistency[,i]== "yes",] %>% 
          ...
          longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = i), position = "center"))
  
}

# # roof
# kable_styling(kable(x = shelter_issues_reason_inconsistency %>% filter(roof=="yes"), longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = "Roof"), position = "center")
# 
# # window
# kable_styling(kable(x = shelter_issues_reason_inconsistency %>% filter(window=="yes"), longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = "window"), position = "center")
# 
# # structure
# kable_styling(kable(x = shelter_issues_reason_inconsistency %>% filter(structure=="yes"), longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = "structure"), position = "center")
# 
# # trap_heat
# kable_styling(kable(x = shelter_issues_reason_inconsistency %>% filter(trap_heat=="yes"), longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = "trap_heat"), position = "center")
# 
# # lack_insulation
# kable_styling(kable(x = shelter_issues_reason_inconsistency %>% filter(lack_insulation=="yes"), longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = "lack_insulation"), position = "center")
```
...
child_income = age*indv_with_income; child_income = rowSums(child_income, na.rm = TRUE)
...
relevant_cols = list(
  "working_outside_home" = c("child_working_long_hours"),
  "lack_content_older_children" = c(older_girls),
  "lack_content_younger_children" = c(young_girls),
  "lack_light" = c("solar_lamps"),
  "marriage_pregnancy" = c("girls_married", "child_marriage"))
...
LI_dist_learning_barriers_girls <- hh_consent_daily %>% mutate(
    ...
    lack_content_older_children = case_when((distance_learning_barriers_girls.lack_content_older_children==1 & all_of(older_girls)==0)~"yes", T~ "no"),
    lack_content_younger_children = case_when((distance_learning_barriers_girls.lack_content_younger_children==1 & all_of(young_girls)==0)~"yes", T~ "no"),
    lack_light = case_when((distance_learning_barriers_girls.lack_light==1 & (solar_lamps=="yes"))~"yes", T~ "no"),
    marriage_pregnancy = case_when((distance_learning_barriers_girls.marriage_pregnancy==1 & (girls_married== "yes" | child_marriage!="yes"))~"yes", T~ "no")) %>%
...
for(i in c("working_outside_home", "lack_content_older_children","lack_content_younger_children","lack_light","marriage_pregnancy")){
  
  print(kable_styling(
    kable(x = LI_dist_learning_barriers_girls[LI_dist_learning_barriers_girls[,i]=="yes",] %>% 
            select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name,
                   distance_learning_barriers_girls, relevant_cols[[i]], additional_girl_cols),
          longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = i), position = "center"))
  
}
# kable_styling(kable(x = LI_dist_learning_barriers_girls, longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE,
...
relevant_cols = list(
  "working_outside_home" = c("child_working_long_hours"),
  "lack_content_older_children" = c(older_boys),
  "lack_content_younger_children" = c(young_boys),
  "lack_light" = c("solar_lamps"),
  "marriage_pregnancy" = c("boys_married", "child_marriage"))

LI_dist_learning_barriers_boys <- hh_consent_daily %>% mutate(
    working_outside_home = case_when((distance_learning_barriers_boys.working_outside_home == 1 & child_working_long_hours != "yes")~"yes", T~ "no"),
    lack_content_older_children = case_when((distance_learning_barriers_boys.lack_content_older_children==1 & all_of(older_boys)==0)~"yes", T~ "no"),
    lack_content_younger_children = case_when((distance_learning_barriers_boys.lack_content_younger_children==1 & all_of(young_boys)==0)~"yes", T~ "no"),
    lack_light = case_when((distance_learning_barriers_boys.lack_light==1 & (solar_lamps=="yes"))~"yes", T~ "no"),
     marriage_pregnancy = case_when((distance_learning_barriers_boys.marriage_pregnancy==1 & (boys_married== "yes" | child_marriage!="yes"))~"yes", T~ "no")) %>%
...
for(i in c("working_outside_home", "lack_content_older_children","lack_content_younger_children","lack_light","marriage_pregnancy")){
  ...
  print(kable_styling(
    kable(x = LI_dist_learning_barriers_boys[LI_dist_learning_barriers_boys[,i]=="yes",] %>% 
            select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name, distance_learning_barriers_boys, relevant_cols[[i]], additional_boy_cols),
          longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = i), position = "center"))
...
send_back_barriers_girls <- hh_consent_daily %>% mutate(
    ...
    working_outside_home =           case_when((send_back_barriers_girls.working_outside_home == 1 & child_working_long_hours != "yes")~"yes", T~ "no"),
    lack_content_older_children =    case_when((send_back_barriers_girls.lack_content_older_children==1 & all_of(older_girls)==0)~"yes", T~ "no"),
    lack_content_younger_children =  case_when((send_back_barriers_girls.lack_content_younger_children==1 & all_of(young_girls)==0)~"yes", T~ "no"),
    marriage_pregnancy =             case_when((send_back_barriers_girls.marriage_pregnancy==1 & (girls_married== "yes" | child_marriage!="yes"))~"yes", T~ "no")) %>%
...
for(i in c("working_outside_home", "lack_content_older_children","lack_content_younger_children","marriage_pregnancy")){
  
  print(kable_styling(
    kable(x = send_back_barriers_girls[send_back_barriers_girls[,i]=="yes",] %>% 
            select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name, send_back_barriers_girls, relevant_cols[[i]], additional_girl_cols), 
          longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = i), position = "center"))
...
LI_send_back_barriers_boys <- hh_consent_daily %>% mutate(
    ...
    working_outside_home = case_when((send_back_barriers_boys.working_outside_home == 1 & child_working_long_hours != "yes")~"yes", T~ "no"),
    lack_content_older_children = case_when((send_back_barriers_boys.lack_content_older_children==1 & all_of(older_boys)==0)~"yes", T~ "no"),
    lack_content_younger_children = case_when((send_back_barriers_boys.lack_content_younger_children==1 & all_of(young_boys)==0)~"yes", T~ "no"),
    marriage_pregnancy = case_when(send_back_barriers_boys.marriage_pregnancy==1 & (boys_married== "yes" | child_marriage!="yes")~"yes", T~ "no")) %>%
...
for(i in c("working_outside_home", "lack_content_older_children","lack_content_younger_children","marriage_pregnancy")){
  ...
  print(kable_styling(
    kable(x = LI_send_back_barriers_boys[LI_send_back_barriers_boys[,i]=="yes",] %>% 
            select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name, send_back_barriers_boys, relevant_cols[[i]], additional_boy_cols),
          longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = i), position = "center"))
...
send_back_challenges_girls <- hh_consent_daily %>% mutate(
  ...
  working_outside_home  = case_when((send_back_challenges_girls.working_outside_home == 1 & child_working_long_hours != "yes")~"yes", T~ "no"),
  lack_content_older_children  = case_when((send_back_challenges_girls.lack_content_older_children==1 & all_of(older_girls)==0)~"yes", T~ "no"),
  lack_content_younger_children = case_when((send_back_challenges_girls.lack_content_younger_children==1 & all_of(young_girls)==0)~"yes", T~ "no"),
  marriage_pregnancy = case_when((send_back_challenges_girls.marriage_pregnancy==1 & (girls_married== "yes" | child_marriage!="yes"))~"yes", T~ "no")) %>%
...
for(i in c("working_outside_home", "lack_content_older_children","lack_content_younger_children","marriage_pregnancy")){
  ...
  print(kable_styling(
    kable(x = send_back_challenges_girls[send_back_challenges_girls[,i]=="yes",] %>% 
            select(reported_date, X_uuid, enumerator_id, enumerator_name, team, instance_name, respondent_id, send_back_challenges_girls, relevant_cols[[i]], additional_girl_cols), 
          longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = i), position = "center"))
}
```
...
send_back_challenges_boys <- hh_consent_daily %>% mutate(
  ...
  working_outside_home = case_when((send_back_challenges_boys.working_outside_home == 1 & child_working_long_hours != "yes")~"yes", T~ "no"),
  lack_content_older_children = case_when((send_back_challenges_boys.lack_content_older_children==1 & all_of(older_boys)==0)~"yes", T~ "no"),
  lack_content_younger_children = case_when((send_back_challenges_boys.lack_content_younger_children==1 & all_of(young_boys)==0)~"yes", T~ "no"),
  marriage_pregnancy = case_when((send_back_challenges_boys.marriage_pregnancy==1 & (boys_married== "yes" | child_marriage!="yes"))~"yes", T~ "no")) %>%
...
for(i in c("working_outside_home", "lack_content_older_children","lack_content_younger_children","marriage_pregnancy")){
  ...
  print(kable_styling(
    kable(x = send_back_challenges_boys[send_back_challenges_boys[,i]=="yes",] %>% 
            select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name, send_back_challenges_boys, relevant_cols[[i]], additional_boy_cols), 
          longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = i), position = "center"))
}
```
...
nutrition_barriers_not_accessed_inconsistency <- hh_consent_daily %>% mutate(
  ...
  select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name,
         # child_not_taken_after_referral_HH_count, nutrition_barriers_not_accessed.already_referred,child_taken_no_support_HH_count,
...
kable_styling(kable(x = nutrition_barriers_not_accessed_inconsistency %>% 
                      filter(child_taken_no_support =="yes" | child_not_taken_after_referral == "yes"),
         #              select(reported_date, X_uuid, enumerator_id, enumerator_name, team, instance_name, 
         #                     child_taken_no_support, child_not_taken_after_referral, 
         #                     child_taken_no_support_HH_count,
         # child_not_taken_after_referral_HH_count, nutrition_barriers_not_accessed_cols, nutrition_barriers_not_accessed.already_referred,
         # ),
                    longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE,
...
if(population=="refugee"){
  ...
  food_barriers <- hh_consent_daily %>% mutate(
    food_barriers = case_when(((food_barriers.no_assistance == 1) |
      ...
      select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name, food_barriers, feedback)
...
relevant_cols = list(
  ...
  "child_marriage" = c("child_marriage", "girls_married", "boys_married"), 
...
group_livelihood_coping_inconsistency <- hh_consent_daily %>% mutate(
  ...
  child_marriage = case_when((child_marriage == "yes" & girls_married == 0 & boys_married == 0)~"yes", TRUE~"no"),
...
for(i in c("selling_food_rations", "child_working_long_hours", "child_marriage", "risk_jobs","adults_working_long_hours")){
...
# kable_styling(kable(x = group_livelihood_coping_inconsistency, longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE,
...
coping_reason_inconsistency_2 <- hh_consent_daily %>% mutate(
  ...
  edu = case_when((coping_reason.education ==1 & rowSums(hh_consent_daily[dist_learning_cols]==0, na.rm = T))~"yes", TRUE~ "no"),
  ...
  shelter = case_when((coping_reason.shelter ==1 & (improvement.dont_know == 0 | improvement.no_improvement == 0 |
                                                      improvement.other == 0 | shelter_expenditure == 0))~"yes", TRUE~ "no"),
  cookingfuel1 = case_when((coping_reason.cooking_fuel ==1 & (cooking_fuel_cols[1] !=1 & cooking_fuel_cols[2] != 1))~"yes", TRUE~ "no"),
...
for(i in 1:length(conflict_cols)){
  ...
  print(kable_styling(
    kable(x = coping_reason_inconsistency_2 %>% filter(coping_reason_inconsistency_2[concol] == "yes") %>%
          ...
          longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, caption = caps[i]), position = "center"))
...
for(i in 1:ncol(amounts)){
  ...
  x = amounts_data_day %>% filter(amounts_data_day[concol] == "yes") %>%
    select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name, colnames(amounts)[i], concol)
    
  print(kable_styling(kable(x = x, longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, 
                            caption = paste0(concol,
                                             "   |  Lower limit is ", round(amounts[3,paste0(concol, "_amount")], 0),
...
for(i in 1:ncol(amounts2)){
  ...
  x = amounts2_data_day[amounts2_data_day[concol] == "yes",] %>%
    select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name, colnames(amounts2)[i], concol)
  print(kable_styling(kable(x = x, longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE, 
                            caption = paste0(concol,
                                             "   |  Lower limit is ", round(amounts2[3,paste0(concol, "_expenditure")], 0),
...
for(i in 1:length(cols)){
  ...
  x = expenditures_data_day %>% filter(expenditures_data_day[concol] == "yes") %>%
    select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name, relevant_cols[i])
...
hh_other_pi_long <- hh_other %>% pivot_longer(-c("reported_date","X_uuid","enumerator_id", respondent_id), names_to = "questions", values_to = "old_value") %>%
  mutate(survey_loop = "HH") %>% 
  group_by(X_uuid) %>% 
...
indv_other <- indv_daily_data %>% 
  ...
  select(X_uuid, repeat_instance_name, parent_instance_name, ind_other_cols)

indv_other <- indv_daily_data %>% 
  left_join(hh_consent_daily %>% select(reported_date, X_uuid, enumerator_id, enumerator_name, team, respondent_id, instance_name)) %>% 
  select(reported_date, X_uuid, repeat_instance_name, parent_instance_name, enumerator_id, enumerator_name, team, respondent_id, instance_name, ind_other_cols)


ind_other_pi_long <- indv_other %>% 
  pivot_longer(-c("reported_date", "X_uuid", "repeat_instance_name", parent_instance_name, "enumerator_id", enumerator_name, team, respondent_id, instance_name), 
               names_to = "questions",values_to = "old_value") %>% 
  mutate(survey_loop = "inividual") %>% 
...
# 
# kable_styling(kable(x = cleaning_log_other, longtable = T, booktabs = T, linesep = "", align = "c", row.names = FALSE,
