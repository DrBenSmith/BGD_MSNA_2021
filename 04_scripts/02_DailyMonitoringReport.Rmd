...
hh_yes_consent_full_data$expenditure_total = rowSums(hh_yes_consent_full_data[,expenditures])
...
hh_yes_consent_daily_data$expenditure_total <- rowSums(hh_yes_consent_daily_data[, colnames(expenditures)[1:5]])
